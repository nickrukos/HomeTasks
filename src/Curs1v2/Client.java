...
public class Client
{
    private LocalDate currentDate;      //Дата явки посетителя
    private LocalTime currentTime;      //Время явки посетителя
    private FitnessZone wishZone;       //желаемая зона
    private Abonement abonement;        //абонемент посетителя
